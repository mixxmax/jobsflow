...
def test_canonical_blocks_and_audit_packet_expose_llmo_placement_metadata(tmp_path):
    ...
    assert {"POS-001", "HYG-001", "BASE-001", "MAP-001", "MAP-002", "STAR-001", "LLMO-001", "CON-001", "EDT-001", "TERM-001", "CL-001", "OPT-001"} == {item["rule_id"] for item in task["rule_pack"]["rules"]}
...
def test_compiled_rule_pack_is_cv_cl_only_and_covers_star_jd_and_llmo():
    ...
    assert {"POS-001", "HYG-001", "BASE-001", "MAP-001", "MAP-002", "STAR-001", "LLMO-001", "CON-001", "EDT-001", "TERM-001", "CL-001", "OPT-001"} == ids
